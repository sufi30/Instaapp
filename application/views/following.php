  ...
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image:linear-gradient(180deg,#960b68 10%,#03113a 100%);">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url(); ?>index.php/UserController/">
        <div class="sidebar-brand-text mx-3" style="text-transform: none !important;font-size: 1.2rem !important;margin-left: 0rem!important;">Instaaplikasi
        </div>
      ...
      <center>
        <a href="/Instaaplikasi/index.php/UserController/ShowEditProfile" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm btn-change" style="background-color: #2895b7;border-color: #3495b7;"><i class="fa fa-pencil fa-sm text-white-50"></i> Edit Profile 
        </a>
      </center>
      <br>
      <center>
